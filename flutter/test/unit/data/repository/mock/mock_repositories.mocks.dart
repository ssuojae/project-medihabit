...
// in medihabit/test/unit/data/repository/mock/mock_repositories.dart.
...
import 'package:medihabit/data/repository/interfaces/i_user_repository.dart'
    as _i8;
import 'package:medihabit/domain/entity/medication.dart' as _i11;
import 'package:medihabit/domain/entity/user.dart' as _i9;
...
class MockIUserRepository extends _i1.Mock implements _i8.IUserRepository {
  ...
  @override
  _i7.Future<void> signInWithKakao() => (super.noSuchMethod(
        Invocation.method(
          #signInWithKakao,
          [],
        ),
  ...
  @override
  _i7.Future<_i9.User?> fetchUser(String? userId) => (super.noSuchMethod(
        Invocation.method(
          #fetchUser,
          [userId],
        ),
...
/// A class which mocks [IMedicationRepository].
///
/// See the documentation for Mockito's code generation for more information.
class MockIMedicationRepository extends _i1.Mock
    implements _i10.IMedicationRepository {
  MockIMedicationRepository() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i7.Stream<List<_i11.Medication>> requestMedications(String? userId) =>
      (super.noSuchMethod(
        Invocation.method(
          #requestMedications,
          [userId],
        ),
        returnValue: _i7.Stream<List<_i11.Medication>>.empty(),
      ) as _i7.Stream<List<_i11.Medication>>);

  @override
  _i7.Future<void> saveMedication(
    String? userId,
  ...
  @override
  _i7.Future<void> removeMedication(
    String? userId,
    String? medicationId,
  ) =>
      (super.noSuchMethod(
